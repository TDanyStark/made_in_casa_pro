...
export function SettingsClient() {
  ...
  const handleDisconnect = async () => {
    try {
      ...
      setSettings((prev) =>
        prev ? { ...prev, google_oauth_connected: false, google_oauth_connected_email: null } : prev
      );
    } catch {
  ...
  const handleSaveDailyReportTime = async () => {
    ...
    try {
      const res = await patch("settings", { daily_report_time: dailyReportTime });
      if (!res.ok) throw new Error(res.error);
  ...
  return (
    <Tabs defaultValue="cuenta">
      <TabsList>
        ...
        {isAdmin && <TabsTrigger value="notificaciones">Notificaciones</TabsTrigger>}
                ...
                {settings?.google_oauth_connected ? (
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      settings.google_oauth_client_secret === null
                    }
                  >
                    {connecting ? (
